...
| **Status**       | Draft v1.22 — M0–M4 ✅ · M5 partial (flow ✅, API 🔜) · M6 ✅ · M7 🔶 partial (hardening: coverage gap tertutup ✅, load test ✅, UAT checklist ✅) — **UI copy policy: teks tanpa emoji (icon hanya di tombol navigasi)** |
| **Tanggal**      | 2026-08-11                                                         |
